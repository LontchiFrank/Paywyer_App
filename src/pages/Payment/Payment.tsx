...
const Payment: React.FC = () => {
    ...
    return (
        <DefaultLayout>
            ...
            {
                open ?
                    <div className="flex flex-col  p-4 mb-10 text-sm text-blue-800 rounded-lg bg-blue-100 border border-blue-300  dark:bg-gray-800 dark:text-blue-400" role="alert">
                        ...
                        <div className='flex justify-between'>
                            <div>
                                ...
                                Here you can create a Payment link (also known as Invoice), share it with your customers, and see all the information about the Payment links created previously.
                            </div>
                            <FaTimes className='text-primary font-normal' onClick={handleClick} style={{ fontSize: '20px' }} />
                        </div>
                        <div className='pl-7'>
                            <span className='font-semibold text-primary'>How to Use:</span>
                            <ol className='pl-4'>
                                <li className='list-disc text-primary'>Press “Create payment link”</li>
                                <li className='list-disc text-primary'>Enter the details of your payment link and click “Confirm”</li>
                                <li className='list-disc text-primary'>Send the link to your customer.</li>
                            </ol>
                        </div>
                    </div> : null
            }
